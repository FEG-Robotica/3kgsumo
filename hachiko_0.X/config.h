...
void setIO(){
    //configurar I/O
    TRISA = 0b11111111;     //seta todos os pinos como entrada
    TRISB = 0b00000000;     //seta todos os pinos como saída
    TRISC = 0b11111111;     //tx input, rx output, demais pinos entradas
    TRISD = 0b00000000;
    TRISE = 0b00000111;
    
    ANSEL0 = 0x80;             //pinos são entradas digitais
    ANSEL1 = 0x01;
}